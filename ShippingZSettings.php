...
define("SHIPPINGZSETTINGS_VERSION","3.0.7.0468");

############################################# Please Read These Instructions #######################################
#
#   Your Attention Please !kUfrukabravatastawrat8xetrud2ub
#
#
...
# 
# Handle cancelled orders?
define("CUBECART_RETRIEVE_ORDER_STATUS_4_CANCELLED", 0);  //Default: 0. If you want to detect cancels in Cubecart, set to 1
# 
# Enter cancelled order Status ID below to retrieve cancelled orders
