...
############################################### SETTINGS #####################################################################
$domain="127.0.0.1";
$dir="Magento/magecasemaker"; //leave blank if not applicable
#   -----------------------------------------------
...
$apiuser= 'udesingi_stamp'; //Magento API User [Please, refer "Magento-Setup-Document.pdf" for details]
$apikey = 'ouiqnl123';//Magento API Key [Please, refer "Magento-Setup-Document.pdf" for details]
